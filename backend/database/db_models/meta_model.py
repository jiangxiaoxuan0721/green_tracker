...
class User(MetaBase):
    ...
    email_verified = Column(Boolean, nullable=False, default=False, comment="邮箱是否已验证")
    verification_code = Column(String(6), nullable=True, comment="邮箱验证码")
    verification_code_expires_at = Column(DateTime(timezone=True), nullable=True, comment="验证码过期时间")
